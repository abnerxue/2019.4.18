...
public class LabelManagerController {
	...
	public Map<String, Object> getLabelList(String name,@RequestParam(defaultValue = "1") Integer pageNo,
	        @RequestParam(defaultValue = "10") Integer pageSize,Integer totleCounts,Integer totalPage){
		Map<String,Object> map = new LinkedHashMap<String,Object>();
		List<Label> labelList = labelManagerService.getLabelList(name,pageNo,pageSize);
		
		totleCounts = labelManagerService.getLabelCount(name);
		totalPage = totleCounts%pageSize==0?totleCounts/pageSize:totleCounts/pageSize + 1;
