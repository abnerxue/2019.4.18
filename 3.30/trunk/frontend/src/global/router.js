      ...
      children: [
        ...
        },
        {
          ...
          beforeEnter: (to, from, next) => {
            if (from.name === 'allPrescription') {
              to.meta.parentPath = urls.ALL_PRESCRIPTION
              to.meta.parentTitle = '所有处方查询'
            } else if (from.name === 'problem') {
              to.meta.parentPath = urls.PROBLEM_PRESCRIPTION
              to.meta.parentTitle = '问题处方查询'
            }
            next()
          }
        }
