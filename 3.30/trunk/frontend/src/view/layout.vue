<template>
  <el-container class="layout">
    <el-header class="header">
      <h1 class="text-white">区域智慧审方平台</h1>
      <div class="user-info">
        ...
        <el-header class="breadcrumb">
          <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <template v-if="$route.matched[2]">
              ...
              <el-breadcrumb-item>
                <span class="font-bold" style="color: #000">{{$route.matched[2].meta.title}}</span>
              </el-breadcrumb-item>
            </template>
            <!-- 工作台 -->
            <template v-if="$route.matched[1].meta.hasParent">
              <!-- <el-breadcrumb-item
              ...
              <el-breadcrumb-item>
                <span class="font-bold" style="color: #000">{{$route.matched[1].meta.title}}</span>
              </el-breadcrumb-item>-->
              <el-breadcrumb-item
                :to="{ path: $route.matched[1].meta.parentPath }"
              >{{$route.matched[1].meta.parentTitle}}</el-breadcrumb-item>
              <el-breadcrumb-item>
                <span class="font-bold" style="color: #000">{{$route.matched[1].meta.title}}</span>
              </el-breadcrumb-item>
            </template>
