...
//            3.1文档类别
            ...
            //创建Excel表单
            HSSFSheet sheet = workbook.createSheet("问题处方信息表");
            //创建日期显示格式
            ...
            headers.setContentDispositionFormData("attachment",
                    new String("问题处方表.xls".getBytes("UTF-8"), "iso-8859-1"));
