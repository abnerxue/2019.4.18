...
public class LabelManagerServiceImpl implements LabelManagerService {
	...
	public List<Label> getLabelList(String name, Integer pageNo, Integer pageSize) {
		// TODO Auto-generated method stub
		return labelManagerMapper.getLabelList(name,pageNo,pageSize);
	}
	...
	/* (non-Javadoc)
	 * @see com.ck.springboot.service.LabelManagerService#getLabelCount(java.lang.String)
	 */
	@Override
	public int getLabelCount(String name) {
		// TODO Auto-generated method stub
		return labelManagerMapper.getLabelCount(name);
	}
}
